...
const path = require("path"); // This line is declared once now.
const app = express();
...
// Example usage of these routers (if this is inside an Express app)
...
// You do not need to redeclare __dirname as it's available in Node.js
